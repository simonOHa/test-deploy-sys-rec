...
class UserLoginAPI(Resource):
    ...
    def post(self):
        try:
            ...
            if user is None:
                is_admin, fic_acceptance, know_peppa_pig, is_test_1_completed,is_test_2_completed,is_test_3_completed = UserModel().create_user(email=credentials.id_token['email'],
